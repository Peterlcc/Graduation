...
//					$().UItoTop({ easingType: 'easeOutQuart' });
	...
	<!-- //header -->
        <!-- Top content -->
        <div class="top-content" style="max-width: 100%; background:url(images/backgroundimg.jpg);background-repeat: no-repeat;
                            ...
                            <div class="form-bottom">
			                    <form role="form" id="registerform"  class="register-form">
			                        ...
			                        <div class="form-group">
										...
										<option >国家机关、党群组织、企事业单位的负责人</option>
        ...
        $("#submit").click(function () {
            ...
            if(password1!=password2){
                ...
                $.ajax({
                    url: "/user/add",
                    dataType:"json",
                    data: {name:username, password: password2,sex:sex,major:occupation},
                    type: "POST",
