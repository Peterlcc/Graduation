...
<%@page import="com.peter.bean.House" import="java.util.List"%>
...
<link href="../../resource/user/css/style.css" rel="stylesheet"
	type="text/css" media="all" />
<!-- stylesheet -->
<link href="../../resource/user/css/detail.css" rel="stylesheet"
	type="text/css" />
<!-- stylesheet -->
<link href="../../resource/like/css/style.css" rel="stylesheet"
	type="text/css" media="all" />
<!-- stylesheet -->
<link href="../../resource/like/css/default.css" rel="stylesheet"
	type="text/css" />
<!-- stylesheet -->
<link href="../../resource/like/css/normalize.css" rel="stylesheet"
	type="text/css" />
<!-- stylesheet -->
<!-- meta tags -->
...
<script type="text/javascript"
	src="../../resource/user/js/numscroller-1.0.js"></script>
...
<script type="text/javascript"
	src="../../resource/user/js/house-collect.js"></script>
...
<body>
	...
	<div class="main-content">
		...
		<div class="agileits-property-details">
			...
			<div class="container">
				<div class="col-md-6 w3ls-property-images">
					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div id="getPics" class="carousel-inner">
							<%
								out.print("<div class='item active'><img class='img-responsive' src='" + imgs.get(0) + "' alt='"
										+ house.getTitle() + "' style='height: 490px;'/></div>");
								for (int i = 1; i < imgs.size(); i++) {
									out.print("<div class='item'><img class='img-responsive' src='" + imgs.get(i) + "' alt='"
											+ house.getTitle() + "' style='height: 490px;'/></div>");
								}
							%>
						</div>
				...
				<div class="col-md-6 ins-details">
					...
					<div class="ins-name" style="height: 10px;">
						<!--title/price-->
						<h3 style="float: left" id="housetitle">${house.title}
							<!--标题title-->
						</h3>
						<span id="houseid" hidden="hidden">${house.id}</span>
						<!-- <button style="float:right;" id="focus"  onclick="userCollect();"><i class=" fa fa-star-o" ></i></button> -->
						<a style="float: right; text-decoration: none; cursor: pointer;"
							id="focus" onclick="userCollect();" class="text-blue">收藏<i
							class=" fa fa-star-o"></i></a>

					</div>
					<div
						style="height: 30px; float: left; color: red; font-size: 30px; margin: 0 0 15px 0;"
						id="houseprice">${house.price}元</div>
					<!--价格price-->
					<div>
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<td colspan="3"><span id="houserenttype"
									class=" badge badge-danger">${house.rentType }</span></td>
							</tr>
							<tr>
								<!--status-->
					...
					<button class="dealer-btn"
						style="float: left; width: 100px; display: inline;" id="Tel"
						style="background-color: gainsboro" onclick="Tel();">查看电话</button>
					&nbsp;&nbsp;&nbsp; <span id="dealer-phone" class="telephone"
						style="display: none;">${house.dealerPhone }</span>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
		...
		<!-- related-properties -->
		<div id="relative" class="wthree-related-properties text-center">
			<!--相关推荐-->
			<div class="container">
